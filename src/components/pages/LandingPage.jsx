      ...
      <div className="dark:text-white text-[0.7rem] sm:text-[1rem] flex flex-col items-center flex-grow my-3 gap-9 sm:gap-16 mb-32 duration-500">
        ...
        <div className="flex flex-col items-center mt-11">
          ...
          <div className="flex flex-wrap gap-8 justify-center  px-4 mt-4  ">
            <div className="rounded-xl shadow-xl border h-56 sm:h-64 w-72 p-4  flex flex-col justify-center gap-5 items-center duration-200 hover:scale-105 dark:border-[#3e5074] dark:bg-[#1F2937]">
              <h1 className="text-xl font-bold text-center">
                Create Multiple Links in One Place
              </h1>
              <p className="dark:text-white text-[#D1D5DB] dark:opacity-60 text-center">
            ...
            <div className="rounded-xl shadow-xl border h-56 sm:h-64 w-72 p-4 flex flex-col justify-center gap-5 items-center duration-200 hover:scale-105 dark:border-[#3e5074] dark:bg-[#1F2937]">
              ...
              <p className="text-[#D1D5DB] dark:text-white dark:opacity-60 text-center">
